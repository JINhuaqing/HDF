...
add_params.can_lams = [0.001, 0.1, 0.2, 0.3, 0.40, 0.50, 0.60,  0.70, 0.80, 1.0, 2.0, 4.0, 16.0]
...
settingcmpn1a = edict(deepcopy(settingcmpn1))
settingcmpn1a.setting = "cmpn1a"
settingcmpn1a.data_gen_params.n = 500

## -------

settingcmpn1b = edict(deepcopy(base_params))
add_params = edict({})
add_params.data_gen_params = edict(deepcopy(base_params.data_gen_params))
add_params.data_gen_params.n = 100 # num of data obs to be genareted
add_params.data_gen_params.cs_fn = lambda c: [c, 0, 0]
...
add_params.setting = "cmpn1b"
add_params.sel_idx =  np.arange(1, add_params.data_gen_params.d)
add_params.can_lams = [0.001, 0.1, 0.2, 0.3, 0.40, 0.50, 0.60,  0.70, 0.80, 1.0, 2.0, 4.0, 16.0]
add_params.can_Ns = [4, 6, 8, 10, 12, 14]
add_params.SIS_ratio = 0.2
settingcmpn1b.update(add_params)
...
add_params.data_gen_params.n = 100 # num of data obs to be genareted
add_params.data_gen_params.cs_fn = lambda c: [c, 0, 0]
add_params.data_gen_params.curve_type = "sinica"
add_params.data_gen_params.data_params["err_dist"] = "normal"
add_params.data_gen_params.data_params["srho"] = 0.3
add_params.data_gen_params.beta_fn = lambda cs: _get_gt_beta(cs, 
                                                             add_params.data_gen_params.d, 
                                                             add_params.data_gen_params.npts, 
                                                             fct=2)
