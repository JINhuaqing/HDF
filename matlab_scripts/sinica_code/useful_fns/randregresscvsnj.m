function [A, B] = randregresscvsnj(y,folds,M,Mr)
%UNTITLED2 此处显示有关此函数的摘要
%   此处显示详细说明 random crossvalidation(ie, cross validation is unknown in
%   advance.)
% input1: y is an n by 1 response vector
% input2: folds=5 or 3 for cv
...
%        range of truncation sizes for j'th predictor, usually,
%        Mr{j}=[1,..,Smaxj]
%%
