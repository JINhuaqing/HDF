...
# lambda: penalty term
# N: num of basis
paras.can_lams = [0.001, 0.01, 0.03, 0.05, 0.07, 0.1, 0.15, 0.2, 0.25, 0.3, 0.35, 2.0, 4.0, 16.0]
paras.can_Ns = [4, 6, 8]
...
paras.intercept_cans = np.linspace(-10, 1, 20) 
# fourier basis
...
paras.save_dir = RES_ROOT/f"simu_logi_setting1_{cs[0]*1000:.0f}"
