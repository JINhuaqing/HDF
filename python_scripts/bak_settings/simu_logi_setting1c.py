...
# lambda: penalty term
# N: num of basis
paras.can_lams = [0.001, 0.1, 0.15, 0.2, 0.23, 0.25, 0.28, 0.3, 0.35, 2.0, 4.0, 16.0]
paras.can_Ns = [4, 6, 8]
...
paras.beta_GT = paras.fourier_basis @ paras.fourier_basis_coefs * 1
...
paras.save_dir = RES_ROOT/f"simu_logi_setting1c_{cs[0]*1000:.0f}"
