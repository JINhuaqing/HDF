...
cs = [args.cs, args.cs, 0.0] # for sinica paper
...
# lambda: penalty term
# N: num of basis
#paras.can_lams = [0.35, 0.40, 0.65, 0.75, 0.80]
paras.can_lams = [0.001, 0.1, 0.3, 0.45, 0.50, 0.55, 0.6, 0.7, 1.0, 2.0, 4.0, 16.0]
paras.can_Ns = [4, 6, 8]
...
# saving path
paras.save_dir = RES_ROOT/f"simu_setting4di_{cs[0]*1000:.0f}"
