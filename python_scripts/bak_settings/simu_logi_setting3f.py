...
# lambda: penalty term
# N: num of basis
paras.can_lams = [0.001, 0.1, 0.2, 0.3, 0.4, 0.45, 0.5, 0.6,  0.7, 0.8, 1.0, 2.0, 4.0, 16.0]
paras.can_Ns = [4, 6, 8]
