...
# lambda: penalty term
# N: num of basis
paras.can_lams = [0.001, 0.01, 0.05, 0.1, 0.15, 0.20, 0.25, 0.3, 0.35, 0.40, 0.45, 0.50, 0.55, 1.0, 2.0, 4.0, 16.0]
paras.can_Ns = [4, 6, 8]
...
# saving path
paras.save_dir = RES_ROOT/f"simu_setting4dil_{cs[0]*1000:.0f}"
