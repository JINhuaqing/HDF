...
# Setting 3: beta1-beta2=0, beta1=(c1+0.5)*coef_fn(0.2), beta2=0.5*coef_fn(0.2)
# Other following Setting 2
...
np.random.seed(0)
# setting
cs = [0.5+args.cs, 0.5, 0.0] # for sinica paper
...
paras.q = 2 # num of other covariates
...
paras.save_dir = RES_ROOT/f"simu_linear_sinica_samebetaX_test1_setting3_{cs[0]*1000:.0f}"
